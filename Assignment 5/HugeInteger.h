...
public:
   ...
   bool operator!=(const HugeInteger& right) const {return !(*this == right);}
   bool operator<(const HugeInteger&) const;
   bool operator>(const HugeInteger&) const;
   bool operator<=(const HugeInteger& right) const {return (*this < right || *this == right);}
   bool operator>=(const HugeInteger& right) const {return (*this > right || *this == right);}
